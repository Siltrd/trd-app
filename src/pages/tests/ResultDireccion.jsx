...
const ResultDireccion = () => {
  ...
  useEffect(() => {
    if (location.state?.result) {
      console.log('🔍 Resultado recibido desde test:', location.state.result);
  ...
  const mensaje = `Hola TRD, hice el test de dirección. Mi resultado fue: "${resultado.title}". Me interesa avanzar con la guía que me corresponde. ¿Cómo seguimos?`;
