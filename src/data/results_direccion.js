const results = {
  ...
  pausa: {
    ...
    diagnostico: 'No estás bloqueada por desidia ni por falta de ideas. Estás en pausa porque hay algo que aún no fue nombrado. Tu cuerpo lo registra antes que tu mente: no avanzás porque hay una parte de vos que está cuidando un duelo, un dolor, una pérdida o una energía que todavía no volvió a vos.',
  ...
  bucle: {
    ...
    diagnostico: 'Sabés que necesitás avanzar, pero no podés evitar darle mil vueltas antes de moverte. Tu búsqueda de certezas te mantiene atrapada en un ciclo que no termina de resolverse. Analizás escenarios, errores, consecuencias… y terminás agotada sin haber hecho nada.',
  ...
  impulso: {
    ...
    diagnostico: 'Tenés energía, ideas, voluntad. Pero no hay un eje claro que ordene todo eso. Accionás, pero sin dirección firme. Te movés rápido, pero sin saber si eso responde a tu deseo real o a una reacción automática. Avanzás, pero no te sentís satisfecha.',
  ...
  contradiccion: {
    ...
    diagnostico: 'Hay dos partes de vos activas, con fuerzas opuestas. Una quiere avanzar. Otra no lo permite. Una sabe lo que quiere. Otra lo pone en duda. No estás confundida: estás en plena transición interna.',
    imagen: 'Sos como un río partido en dos cauces que todavía no logran unirse.',
    coste: 'No hay descanso real cuando vivís partida. Desde fuera todo parece normal. Adentro hay fractura silenciosa.',
    cta: {
